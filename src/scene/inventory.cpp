...
Inventory::Inventory(OpenGLContext *context) : Drawable(context)
{}

void Inventory::create()
{
    GLuint idx[6]{0, 1, 2, 0, 2, 3};
    glm::vec4 vert_pos[4] {glm::vec4(-.3f, -.4f, .0000000001f, 1.f),
                           glm::vec4(.3f, -.4f, .0000000001f, 1.f),
                           glm::vec4(.3f, .4f, .0000000001f, 1.f),
                           glm::vec4(-.3f, .4f, .0000000001f, 1.f)};

    glm::vec2 vert_UV[4] = {glm::vec2(8.f / 16.f, 2.f / 16.f),
                             glm::vec2(12.f / 16.f, 2.f / 16.f),
                             glm::vec2(12.f / 16.f, 6.f / 16.f),
                             glm::vec2(8.f / 16.f, 6.f / 16.f)};
