...
public:
    ...
    int attrBlock; // A handle for the "in" vec2 representing the UV coordinates in the vertex shader
    int attrData;
    ...
    int unifEyePos; // A handle for the "uniform vec4 representing the camera's world space position

    int unifDimensions; //dimensions of screen
    int unifEye; //eye
public:
